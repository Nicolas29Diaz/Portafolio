...
export function Scenario(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-4.579, 1.474, 5.334]} rotation={[0.029, -1.534, 0.029]}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[7.507, 1.59, 3.802]} rotation={[Math.PI, -0.933, Math.PI]} scale={0.124}>
        <mesh
          castShadow
          receiveShadow
      ...
      <mesh
        ...
        scale={0.458}
      />
      <group position={[-3.798, 0, -5.808]} rotation={[0, -1.536, 0]} scale={0.012}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-4.52, 0, -5.291]} rotation={[Math.PI, -0.68, Math.PI]} scale={0.008}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[5.949, 0, -6.348]} rotation={[Math.PI, -0.866, Math.PI]} scale={1.439}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[0, 7.483, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={260.31}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[8.049, 0.771, -3.8]} rotation={[-Math.PI / 2, 0, -1.551]} scale={0.512}>
        <mesh
          castShadow
          receiveShadow
